  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 start-6 z-50 w-[340px] sm:w-[380px] rounded-2xl overflow-hidden flex flex-col"
            style={{
      ...
      <motion.button
        ...
        className="fixed bottom-6 start-6 z-50 w-14 h-14 rounded-full flex items-center justify-center cursor-pointer shadow-lg"
