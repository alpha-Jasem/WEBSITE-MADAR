...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#1E3A6E] p-2 md:p-4 bg-[#050A14] rounded-[30px] shadow-2xl"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-[#080E1C]">
      {children}
    </div>
  </motion.div>
);
