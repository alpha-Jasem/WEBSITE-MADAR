  ...
  return (
    <div className="fixed bottom-6 end-6 z-50 flex items-center gap-3">
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="glass px-4 py-2 rounded-xl text-sm text-white whitespace-nowrap"
          >
      ...
      >
        ...
        <span className="absolute inset-0 rounded-full animate-pulse-slow opacity-20" style={{ background: '#25D366' }} />
