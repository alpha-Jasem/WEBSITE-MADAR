...
import { Badge } from "@dv3/components/ui/badge";
import {
  Table,
  TableCell,
  TableHead,
  TableHeader,
  TableRow,
} from "@dv3/components/ui/table";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@dv3/components/ui/tooltip";
import { Button } from "@dv3/components/ui/button";
import { Avatar, AvatarFallback, AvatarImage } from "@dv3/components/ui/avatar";
import { format } from "date-fns";
import { TicketContext } from "@dv3/context/ticket-context";
import {
  AnimatedTableWrapper,
  AnimatedTableBody,
  AnimatedTableRow,
} from "@dv3/components/animated-components/animated-table";
import InputPlaceholderAnimate from "@dv3/components/animated-components/animatedinput-placeholder";
import { Alert, AlertTitle } from "@dv3/components/ui/alert";
