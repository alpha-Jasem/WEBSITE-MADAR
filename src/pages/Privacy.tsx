      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '8rem 1.5rem 3rem' }}>
        ...
        <div style={{ maxWidth: 720 }}>
          ...
          <div className="lp-section">
            ...
            <p className="lp-p">
              مدار OS ("مدار"، "نحن"، "لنا") منصة برمجيات سعودية تقدم أنظمة تشغيل ذكية للمنشآت التجارية كمغاسل السيارات والعيادات. توضح سياسة الخصوصية هذه كيف نتعامل مع المعلومات عند استخدامك لموقعنا أو للتواصل معنا أو عند اشتراكك في خدماتنا.
            </p>
            <p className="lp-p">
