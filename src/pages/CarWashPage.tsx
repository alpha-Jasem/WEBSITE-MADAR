  ...
  return (
    <div dir="rtl" style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'IBM Plex Sans Arabic, Tajawal, Cairo, sans-serif' }}>
      ...
      <section className="relative min-h-[760px] overflow-hidden bg-white sm:min-h-[820px] lg:min-h-0">
        ...
        <div className="absolute inset-0 z-10 mx-auto flex max-w-7xl items-start justify-end px-4 pt-28 sm:items-center sm:px-6 sm:pt-16 lg:px-8">
          <div className="hero-copy w-full max-w-[560px] text-right text-[#0D1B3E]">
