      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div {...reveal}>
          ...
          <h2 style={{ fontSize: 'clamp(22px,4vw,36px)', fontWeight: 900, color: '#fff', fontFamily: 'Cairo, sans-serif', margin: '0 0 16px', lineHeight: 1.3 }}>
            "نورا" — مساعدتك الذكية على واتساب
          </h2>
        ...
        <motion.div {...reveal} transition={{ delay: 0.15 }}>
          <div style={{ borderRadius: 24, overflow: 'hidden', border: '3px solid #0D1B3E', boxShadow: '0 24px 60px rgba(0,0,0,0.4)', maxWidth: 320, margin: '0 auto' }}>
            ...
            <div style={{ background: '#075E54', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <p style={{ margin: 0, color: '#fff', fontFamily: 'Cairo, sans-serif', fontWeight: 700, fontSize: 13 }}>نورا — مساعدة العيادة</p>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div style={{ position: 'relative' }}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6" style={{ position: 'relative', zIndex: 1 }}>
          {[
            { week: 'الأسبوع 1', color: '#0099CC', title: 'التحليل والإعداد', points: ['فهم جدولك الحالي', 'إعداد واتساب Business', 'تدريب نورة على عيادتك'] },
        ...
        {[
          {
            ...
            features: ['مساعد واتساب AI نورة', 'جدول مواعيد رقمي', 'تذكيرات تلقائية للمرضى', 'لوحة تحكم أساسية', 'تدريب الفريق (ساعتين)', 'دعم شهر كامل'],
...
/* ─── 7. FAQ ─────────────────────────────────────────────────────── */
const faqs = [
  { q: 'هل يفهم النظام اللهجة السعودية؟', a: 'نعم — نورة مدربة على اللهجة الخليجية السعودية تحديداً. تفهم "أبي أحجز" و"وش الدوام" وغيرها من العبارات اليومية.' },
