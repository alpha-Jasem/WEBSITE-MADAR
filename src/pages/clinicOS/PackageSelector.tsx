...
const PACKAGES = [
  {
    ...
    name: 'واتساب AI',
    subtitle: 'استقبال وحجوزات عبر واتساب',
    price: '15,000 ريال / سنة',
    badge: 'ابدأ من هنا',
    badgeColor: '#059669',
    badgeBg: '#ECFDF5',
    color: '#4F46E5',
    ...
    icon: Zap,
    features: [
      'موظف استقبال ذكي عبر واتساب',
      'تحويل المحادثات إلى حجوزات',
      'تذكيرات المواعيد التلقائية',
      'متابعة الفرص غير المكتملة',
    ],
    locked: ['استقبال المكالمات بالذكاء الاصطناعي', 'استعادة المكالمات الفائتة'],
    cta: 'تجربة باقة واتساب',
  },
  {
    id: 'ai_pro' as PackageType,
    name: 'AI Pro',
    subtitle: 'واتساب + اتصال ذكي كامل',
